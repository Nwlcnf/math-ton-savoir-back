...
@Tag(name = "Utilisateur", description = "Opérations liées aux utilisateurs")
public class UtilisateurController {
    ...
    public ResponseEntity<UtilisateurDTO> getById(@PathVariable Long id) {
        ...
        if (dto == null) throw new ResourceNotFoundException("Utilisateur " + id + " non trouvé");
    ...
    public ResponseEntity<UtilisateurDTO> update(@PathVariable Long id, @RequestBody UtilisateurDTO dto) {
        ...
        if (updated == null) throw new ResourceNotFoundException("Utilisateur " + id + " non trouvé");
